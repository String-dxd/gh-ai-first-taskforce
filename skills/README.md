...
Claude Code skills installed by `gh ai-first-taskforce setup`.
...
| [aif-design-issue](aif-design-issue/SKILL.md) | Produces a design for a GitHub issue before implementation — for designers: implements a design branch with local tunnel for user testing and opens a draft PR as handoff; for engineers: produces a design spec mapping each AC scenario to components, layout, and states. |
